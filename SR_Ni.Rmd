...
**Diskussion:**
  ...
  - Diese Spitze ist in jedem Abschnitt zu sehen und nimmt mit der Zeit ab. Die Abnahme ist unterschiedlich von Abschnitt zu Abschnitt. Diese Abnahme ist viele kleiner als erwartet. Nach 2 Jahren ist immer noch eine Schleifrauheit zu sehen. 
  ...
  - Die Schallmessung weist für alle Abschnitte eine starke Tonalität auf. Dies entspricht nicht mit der kürzlich gemessenen SR überein, wo nur die Referenz eine solche Spitze aufweist.
...
Die Anwendung der Korrekturen auf  die ist wie folgt abgeleitet:
...
Um diesem Verfahren darzustellen wenden wir die Korrekturen für den Abschnitt B2 auf SD Wirkungen berechnet aus IC wagenbezogene Spektren. 
...
Als Beispiel wenden wir die Korrekturen des Abschnitt B2 an die wagenbezognen Spektren von IC Züge. Das folgende Bild zeigt den Vergleich Zwischen Korrigierte und nicht Korrigierte SD Wirkungen
...
- Die SD Wirkung nimmt für jede Korrektur stark ab. Für den relevante 2000Hz Band ist die korrigierte Wirkung stark negatv.
- Aufgrund dieser Bild wird auf eine Korrektur verzichtet. Eine deutliche lärmerhöung durch SD scheint zu umplausibel.
- Trotzdem muss beachtet werden dass  die Korrektur, obwohl quantitativ unplausible Werte liefert, auf eine übergeschätzte SD Wirkung hindeutet.
...
>  - SR in Niederwangen haben eine Spitze bei einer Wellenlänge von 2cm.
   ...
   - Die Auswahl einer repräsentative SR für jeden Abschnitt ist nicht möglich.
   ...
   - Die gemessene Wirkung der SD muss dennoch im Kontext der unterschiedlichen SR der Abschnitte relativiert werden.Die SR deutet auf eine übergeschätzte SD Wirkung hin. 

...
```
  ...
  **Diskussion**:
  ...
  -  Die oberen Punkten bestätigen die Erklärung der Tonalität durch die hohe SR. Mann kann schliessen, dass diese SR (bei 2cm Wellenlänge) in ähnlichem Mass auf beiden Abschnitten vorhanden ist. 
  
Die Vorbeifahrt nummer 6 besteht aus einem Regio Zug welcher 100 km/h gefahren ist. Dieser Zug muss aufgrund der tieferen  Geschwindigkeit separat betrachtet werden. Im nächsten Bild sind die Spektren dieses Zugs dargestellt.
...
``` 
  ...
  **Diskussion**:
  ...
  - Die Wagen Spektren weisen einen sehr hohen tonalen Anteil beim 1600Hz Band auf. Das entspricht der Anregung der 2cm Wellenlänge, welche umgewandelt in Frequenz (für 100 km/h) `r v= 100/3.6; round(v/0.02,-1) ` \, Hz  entspricht.
  ...
  - Weiter kann behauptet werden, dass die SR (bei 2cm Wellenlänge) in ähnlichen Mass auf beiden Abschnitten vorhanden ist.

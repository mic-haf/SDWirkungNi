...
```
  **Diskussion**:
  ...
  - Die  IC Spektren weisen ein sehr hohen tonales Anteil bei $2000 Hz$ auf. Eine mögliche Erklärung ist der höhe Rauheitwert bei $2\,cm$ Wellenlänge welche umgewandelt in Frequenz (für $140 km/h$) entspricht $`r v= 140/3.6; round(v/0.02,-1) ` \, Hz$.
...
```
  ...
  **Diskussion**:
  ...
  - Die Streuung ist viel grösser als erwartet. Zwischen unterschiedliche Wagen der gleiche Vorbeifahrt sind Variationen bis 5 dBA zu sehen
  - Die Streuung zwischen unterschiedliche Vorbeifahrt  sind bis zu 2-3dBA Unterschieden zu sehen.
  - Die Variabilität der Wagen innerhalb ein einziges Zug ist Grösser als die Variabilität Zwischen verschiedene Vorbeifahrt falls die median betrachtet wird.
  - Die Variabilität eine Vorbeifahrt ist nicht konstant  auf beide Abschnitte. Damit ist es nicht möglich die Streuung zu Erklären aufgrund unterschiedlich Radrauheiten. 

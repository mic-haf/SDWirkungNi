...
---
```{r echo = F}
git_commit = "e-sr/SDWirkungNi/master"
...
Im Bericht [Messbericht Vorbeifahrtsmessungen Niederwangen](`r paste(pdf_render, "Messbericht Vorbeifahrtsmessungen Niederwangen sig.pdf", "}", sep = "")`) sind eine detallierte Beschreibung und die erste Resultate der Wirkung von SD zu sehen. (Aufpassen dass in diesem Bericht die Abschnitte anders bennant worden)
...
Diesem Bericht besteht aus mehrere Teildokumente welche in einem git [repo](https://github.com/e-sr/ValFX) (hosted auf github) abgelegt sind.
